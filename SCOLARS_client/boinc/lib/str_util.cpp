...
const char* boincerror(int which_error) {
    switch (which_error) {
        ...
        // BOINC-MR
        case ERR_MR_GETADDRINFO: return "BOINC-MR getaddrinfo() failed";
        case ERR_MR_CLIENT_SOCKET_SEND: return "BOINC-MR send() failed";
        case ERR_MR_CLIENT_SOCKET_RECV: return "BOINC-MR recv() failed";
        case ERR_MR_INVALID_ADDR: return "invalid Mapper address";
        case ERR_MR_FILE_SIZE: return "unexpected file size";
        case ERR_MR_CONN_ATTEMPTS: return "too many failed client connection attempts";
        case ERR_MR_CLIENT_REQ_PREFIX: return "BOINC-MR Client connection: error parsing file request from client [wrong prefix]";
        case ERR_MR_FILE_NOT_SERVED: return "requested file not being served (does not exist or unavailable for upload)";
    }
    static char buf[128];
...
const char *BOINC_RCSID_ab90e1e = "$Id: str_util.cpp 19480 2009-11-05 18:02:51Z davea $";
