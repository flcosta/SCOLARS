...
// BOINC-MR
// Errors when attempting client-to-client transfer
#define ERR_MR_GETADDRINFO          -901
///#define ERR_CLIENT_SOCKET_CONNECT   -902         // unnecessary - already ERR_CONNECT
#define ERR_MR_CLIENT_SOCKET_SEND   -903
#define ERR_MR_CLIENT_SOCKET_RECV   -904
#define ERR_MR_INVALID_ADDR         -905
#define ERR_MR_FILE_SIZE            -906
#define ERR_MR_CONN_ATTEMPTS        -907
#define ERR_MR_CLIENT_REQ_PREFIX    -908
#define ERR_MR_FILE_NOT_SERVED      -909
