...
void boinc_catch_signal(int signal) {
    ...
    // BOINC-MR DEBUG
    fprintf(stderr, "Diagnostics.cpp - Inside boinc_catch_signal.\n");
    printf("Diagnostics.cpp - Inside boinc_catch_signal - Signal: %d.\n",signal);
    fflush(stdout);

    if (signal == SIGABRT){
        printf("Diagnostics.cpp - Caught SIGABRT.\n");
        fflush(stdout);
    }
...
const char *BOINC_RCSID_4967ad204c = "$Id: diagnostics.cpp 19583 2009-11-16 13:13:42Z bema $";
