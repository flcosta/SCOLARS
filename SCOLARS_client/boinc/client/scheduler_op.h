...
struct SCHEDULER_REPLY {
    ...
    // D_VAL
    std::vector<std::string> dval_req_outputs;
        // list of D_VAL WU names whose output files are required
    std::vector<std::string> dval_req_inputs;
        // list of wu names (alt_name of D_VAL WU) whose input files are required
    std::string dval_req_url;
        // URL to upload requested files to
