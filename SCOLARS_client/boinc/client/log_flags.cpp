...
void CONFIG::clear() {
    ...
    // BOINC-MR
    max_client_xfers = MAX_CLIENT_XFERS;
    max_client_xfers_per_project = MAX_CLIENT_XFERS_PER_PROJECT;
}
...
const char *BOINC_RCSID_5f23de6652 = "$Id: log_flags.cpp 20651 2010-02-18 23:53:14Z davea $";
