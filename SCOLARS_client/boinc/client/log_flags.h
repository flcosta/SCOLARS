...
// BOINC-MR
#define MAX_CLIENT_XFERS_PER_PROJECT      6
#define MAX_CLIENT_XFERS                  24
    // more frequent than normal file xfer
...
struct CONFIG {
    ...
    // BOINC-MR
    int max_client_xfers;
    int max_client_xfers_per_project;
};
