...
int wu_delete_files(WORKUNIT& wu) {
    char* p;
    /// BOINC-MR TODO : cleanup this - hack to allow wu.xml_doc to be MEDIUM_BLOB_SIZE to create reduce wu.
...
const char *BOINC_RCSID_bd0d4938a6 = "$Id: file_deleter.cpp 19079 2009-09-17 17:56:59Z davea $";
