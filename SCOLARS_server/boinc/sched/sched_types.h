...
struct SCHEDULER_REQUEST {
    ...
    // BOINC-MR
    bool mr_client;
        // true if this request came from client that is able to host/upload map outputs in MapReduce job
...
struct SCHEDULER_REPLY {
    ...
    // D_VAL
    std::vector<std::string>dval_result_output_files;
        // list of Result names whose output files must be returned by client/host
    std::vector<std::string>dval_wu_input_files;
        // list of WU names whose input files must be returned by client/host
