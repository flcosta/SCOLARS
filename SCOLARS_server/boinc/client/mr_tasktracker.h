...
#define MR_DATASIZE_SEND        256
    // size of buffer used to send data to client reducer
#define MR_DATASIZE_RECV        256
...
private:
    int mr_conn_start_t;        // instant when connection was initiated
...
public:
    ...
    char* mr_downloading_user;  // user that is downloading this file (IP)
