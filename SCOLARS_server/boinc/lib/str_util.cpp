...
const char* boincerror(int which_error) {
    switch (which_error) {
        ...
        // errors concerning distributed validation
        case ERR_DIST_VAL_UNIQUE_ALT_NAMES: return "could not create unique alternative names, when modifying result template";
    }
    static char buf[128];
